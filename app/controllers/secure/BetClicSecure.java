...
public class BetClicSecure extends Controller {
    ...
    private static void check(Check check) throws Throwable {
        for(String profile : check.value()) {
            boolean hasProfile = (Boolean)BetClicSecure.Security.invoke("check", profile);
            if(!hasProfile) {
                BetClicSecure.Security.invoke("onCheckFailed", profile);
            }
        }
    }
    ...
    public static void authenticate(@Required String username, String password, boolean remember) throws Throwable {
        ...
        try {
            ...
            allowed = (Boolean) BetClicSecure.Security.invoke("authentify", username, password);
        } catch (UnsupportedOperationException e ) {
            // This is the official method name
            allowed = (Boolean) BetClicSecure.Security.invoke("authenticate", username, password);
        }
    ...
    public static void logout() throws Throwable {
        BetClicSecure.Security.invoke("onDisconnect");
        session.clear();
        response.removeCookie("rememberme");
        BetClicSecure.Security.invoke("onDisconnected");
    ...
    static void redirectToOriginalURL() throws Throwable {
        BetClicSecure.Security.invoke("onAuthenticated");
